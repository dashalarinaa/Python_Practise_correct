# Напишите программу, которая отделяет положительные элементы массива от отрицательных: переставляет все положительные 
# (в том же порядке) в начало массива, а все отрицательные (в том же порядке) – в конец массива, все нулевые элементы 
# должны оказаться в середине массива.
...
numbers = numbers + [0] * count + numbers_negative
